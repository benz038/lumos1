...
DAUTH_CLIENT_SECRET = "8qDPCbJOK.b2Gz3GHOrUK1lU-CgIsQ1h"
DAUTH_REDIRECT_URI = "http://64.227.164.155:8000/callback"
...
def dauth_login():
    ...
    # https://auth.delta.nitt.edu/authorize?response_type=code&client_id=kYsE8Z7gKhwpjrRQ&redirect_uri=http://dskushwah.pythonanywhere.com/callback&scope=user
